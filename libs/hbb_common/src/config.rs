...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Green4You Assist".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["assist.green4you.cloud"];
pub const RS_PUB_KEY: &str = "bvMZ6fdlMAUvdimOQP4+9FC6gYhZHnx1SpUhkWqSnzY=";
